...
<div class="card card-primary">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <input type="file" id="inputName" class="form-control" value="">
        </div>
        <div class="form-group">
            <label for="inputClientCompany">Ngày đăng</label>
            <input type="date" id="inputClientCompany" class="form-control" value="">
        </div>

        <button type="button" class="btn btn-outline-danger">Thêm Tin Tức</button>
    </div>
    <!-- /.card-body -->
</div>